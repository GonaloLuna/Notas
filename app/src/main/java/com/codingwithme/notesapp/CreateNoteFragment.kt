...
class CreateNoteFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"Url requerido",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"Título requerido",Toast.LENGTH_SHORT).show()
        }
        else if (etNoteSubTitle.text.isNullOrEmpty()){

            Toast.makeText(context,"Subtítulo requerido",Toast.LENGTH_SHORT).show()
        }

        else if (etNoteDesc.text.isNullOrEmpty()){

            Toast.makeText(context,"Descripción requerida",Toast.LENGTH_SHORT).show()
        }
    ...
    private fun checkWebUrl(){
        if (Patterns.WEB_URL.matcher(etWebLink.text.toString()).matches()){
            ...
            Toast.makeText(requireContext(),"Url inválido",Toast.LENGTH_SHORT).show()
        }
    }
